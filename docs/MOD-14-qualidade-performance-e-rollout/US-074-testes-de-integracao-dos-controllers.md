# PRD — US 074 — Testes de integração dos controllers
...
Esta especificação detalha exclusivamente **US 074 — Testes de integração dos controllers**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Testes de integração dos controllers** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** HTTP, socket, áudio e storage usam fakes.
- **RF-02:** Verifica uma conexão, cleanup, retry e snapshot.

## 7. Critérios de aceite

- [ ] **CA-01:** HTTP, socket, áudio e storage usam fakes.
- [ ] **CA-02:** Verifica uma conexão, cleanup, retry e snapshot.
