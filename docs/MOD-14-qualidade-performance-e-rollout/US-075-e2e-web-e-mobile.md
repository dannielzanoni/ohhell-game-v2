...
Esta especificação detalha exclusivamente **US 075 — E2E Web e Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **E2E Web e Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Playwright cobre: guest, criar, compartilhar/entrar, ready, bid, jogar, resultado, ranking, idioma e preferências.
- **RF-02:** Viewports mínimos: 360×800, 390×844, 768×1024 e 1440×900.
- **RF-03:** Ao menos um teste redimensiona durante a partida e confirma socket único.

## 7. Critérios de aceite

- [ ] **CA-01:** Playwright cobre: guest, criar, compartilhar/entrar, ready, bid, jogar, resultado, ranking, idioma e preferências.
- [ ] **CA-02:** Viewports mínimos: 360×800, 390×844, 768×1024 e 1440×900.
- [ ] **CA-03:** Ao menos um teste redimensiona durante a partida e confirma socket único.
