# PRD — US 080 — Feature flag e rollout
...
Esta especificação detalha exclusivamente **US 080 — Feature flag e rollout**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Feature flag e rollout** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Flag separa Mobile atual e Mobile v2 durante migração.
- **RF-02:** QA pode forçar plataforma/flag por query sem persistir em produção.
- **RF-03:** Rollback não altera contratos nem dados.

## 7. Critérios de aceite

- [ ] **CA-01:** Flag separa Mobile atual e Mobile v2 durante migração.
- [ ] **CA-02:** QA pode forçar plataforma/flag por query sem persistir em produção.
- [ ] **CA-03:** Rollback não altera contratos nem dados.
