# PRD — US 078 — Acessibilidade e motion
...
Esta especificação detalha exclusivamente **US 078 — Acessibilidade e motion**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Acessibilidade e motion** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Foco, nomes acessíveis, contraste, teclado e toque são auditados.
- **RF-02:** `prefers-reduced-motion` desativa animações não essenciais.
- **RF-03:** Eventos críticos não são comunicados apenas por cor/som.

## 7. Critérios de aceite

- [ ] **CA-01:** Foco, nomes acessíveis, contraste, teclado e toque são auditados.
- [ ] **CA-02:** `prefers-reduced-motion` desativa animações não essenciais.
- [ ] **CA-03:** Eventos críticos não são comunicados apenas por cor/som.
