# PRD — US 081 — Observabilidade de frontend
...
Esta especificação detalha exclusivamente **US 081 — Observabilidade de frontend**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Observabilidade de frontend** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Eventos não contêm token, nick sensível ou URL autenticada.
- **RF-02:** Métricas diferenciam Web/Mobile, fase da sessão e tipo de falha.
- **RF-03:** Integra com a observabilidade já presente no backend `origin/main`.

## 7. Critérios de aceite

- [ ] **CA-01:** Eventos não contêm token, nick sensível ou URL autenticada.
- [ ] **CA-02:** Métricas diferenciam Web/Mobile, fase da sessão e tipo de falha.
- [ ] **CA-03:** Integra com a observabilidade já presente no backend `origin/main`.
