# PRD — US 076 — Lazy loading por rota e plataforma
...
Esta especificação detalha exclusivamente **US 076 — Lazy loading por rota e plataforma**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Lazy loading por rota e plataforma** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Rotas usam `React.lazy`/chunks equivalentes.
- **RF-02:** View Web não entra no chunk inicial Mobile e vice-versa quando possível.
- **RF-03:** Assets de decks são carregados sob demanda.

## 7. Critérios de aceite

- [ ] **CA-01:** Rotas usam `React.lazy`/chunks equivalentes.
- [ ] **CA-02:** View Web não entra no chunk inicial Mobile e vice-versa quando possível.
- [ ] **CA-03:** Assets de decks são carregados sob demanda.
