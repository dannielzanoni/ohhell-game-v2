# PRD — US 073 — Testes unitários de domínio/frontend
...
Esta especificação detalha exclusivamente **US 073 — Testes unitários de domínio/frontend**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Testes unitários de domínio/frontend** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Vitest cobre contratos, storage, auth refresh, cards e reducer da partida.
- **RF-02:** Timers usam clock falso.
- **RF-03:** Views são testadas com view models, sem backend real.

## 7. Critérios de aceite

- [ ] **CA-01:** Vitest cobre contratos, storage, auth refresh, cards e reducer da partida.
- [ ] **CA-02:** Timers usam clock falso.
- [ ] **CA-03:** Views são testadas com view models, sem backend real.
