...
Esta especificação detalha exclusivamente **US 079 — CI de qualidade**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **CI de qualidade** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Frontend: install congelado, lint, testes e build.
- **RF-02:** Backend: format, clippy, testes e build.
- **RF-03:** Deploy depende dos gates anteriores.

## 7. Critérios de aceite

- [ ] **CA-01:** Frontend: install congelado, lint, testes e build.
- [ ] **CA-02:** Backend: format, clippy, testes e build.
- [ ] **CA-03:** Deploy depende dos gates anteriores.
