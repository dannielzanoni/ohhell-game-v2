# PRD — US 072 — Abrir repositório

**Módulo:** MOD 13 — GitHub e informações externas  
**Status:** Planejado  
...
manter a saída externa explícita e simples.

Esta especificação detalha exclusivamente **US 072 — Abrir repositório**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Abrir repositório** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Link externo é único e configurável.
- **RF-02:** Web abre nova aba; Mobile permite abertura pelo sistema.
- **RF-03:** A rota intermediária deve ser removida ou adotada consistentemente, não permanecer duplicada.

## 7. Critérios de aceite

- [ ] **CA-01:** Link externo é único e configurável.
- [ ] **CA-02:** Web abre nova aba; Mobile permite abertura pelo sistema.
- [ ] **CA-03:** A rota intermediária deve ser removida ou adotada consistentemente, não permanecer duplicada.

## 8. Diretriz técnica

Tratar navegação externa explicitamente, sem duplicar destinos ou depender de APIs fora do navegador.
