# PRD — US 035 — Presença de jogadores

**Módulo:** MOD 06 — Lobby e pré-partida  
**Status:** Planejado  
...
Esta especificação detalha exclusivamente **US 035 — Presença de jogadores**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Presença de jogadores** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** `PlayerJoined` e `PlayerLeft` atualizam as duas views pelo mesmo reducer.
- **RF-02:** Máximo visual e de produto é alinhado ao backend antes da release; hoje UI assume 10 e backend suporta até 13.

## 7. Critérios de aceite

- [ ] **CA-01:** `PlayerJoined` e `PlayerLeft` atualizam as duas views pelo mesmo reducer.
- [ ] **CA-02:** Máximo visual e de produto é alinhado ao backend antes da release; hoje UI assume 10 e backend suporta até 13.
