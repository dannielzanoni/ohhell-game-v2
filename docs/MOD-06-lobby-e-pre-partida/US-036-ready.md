...
Esta especificação detalha exclusivamente **US 036 — Ready**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Ready** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Comando é `PlayerStatusChange`.
- **RF-02:** Ação exige ao menos dois jogadores e socket aberto.
- **RF-03:** Estado pending evita envios repetidos.

## 7. Critérios de aceite

- [ ] **CA-01:** Comando é `PlayerStatusChange`.
- [ ] **CA-02:** Ação exige ao menos dois jogadores e socket aberto.
- [ ] **CA-03:** Estado pending evita envios repetidos.
