...
Esta especificação detalha exclusivamente **US 038 — Convite Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Convite Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Usa Web Share API; fallback copia o link.
- **RF-02:** Cancelar share não é tratado como erro.

## 7. Critérios de aceite

- [ ] **CA-01:** Usa Web Share API; fallback copia o link.
- [ ] **CA-02:** Cancelar share não é tratado como erro.
