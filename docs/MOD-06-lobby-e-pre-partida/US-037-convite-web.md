...
Esta especificação detalha exclusivamente **US 037 — Convite Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Convite Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Clipboard possui fallback e feedback temporário.
- **RF-02:** Link usa origem atual e rota canônica.

## 7. Critérios de aceite

- [ ] **CA-01:** Clipboard possui fallback e feedback temporário.
- [ ] **CA-02:** Link usa origem atual e rota canônica.
