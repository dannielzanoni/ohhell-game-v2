# PRD — US 039 — Falha e reconexão no lobby
...
Esta especificação detalha exclusivamente **US 039 — Falha e reconexão no lobby**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Falha e reconexão no lobby** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** UI diferencia offline, reconectando e erro definitivo.
- **RF-02:** Reconexão usa backoff limitado e solicita snapshot.
- **RF-03:** Não abre sockets paralelos.

## 7. Critérios de aceite

- [ ] **CA-01:** UI diferencia offline, reconectando e erro definitivo.
- [ ] **CA-02:** Reconexão usa backoff limitado e solicita snapshot.
- [ ] **CA-03:** Não abre sockets paralelos.
