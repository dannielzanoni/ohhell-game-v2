# PRD — US 062 — Painel Web de configurações

**Módulo:** MOD 10 — Configurações e personalização  
**Status:** Planejado  
...
Esta especificação detalha exclusivamente **US 062 — Painel Web de configurações**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Painel Web de configurações** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Abas têm foco, labels e fechamento acessíveis.
- **RF-02:** Altura não depende de valores frágeis do viewport.

## 7. Critérios de aceite

- [ ] **CA-01:** Abas têm foco, labels e fechamento acessíveis.
- [ ] **CA-02:** Altura não depende de valores frágeis do viewport.
