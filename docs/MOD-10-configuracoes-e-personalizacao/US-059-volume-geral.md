...
Esta especificação detalha exclusivamente **US 059 — Volume geral**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Volume geral** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Atualização é imediata e persistida.
- **RF-02:** Controle possui valor acessível e funciona por teclado/toque.

## 7. Critérios de aceite

- [ ] **CA-01:** Atualização é imediata e persistida.
- [ ] **CA-02:** Controle possui valor acessível e funciona por teclado/toque.
