...
Esta especificação detalha exclusivamente **US 060 — Tipo de baralho**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Tipo de baralho** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Preview usa assets otimizados.
- **RF-02:** Trocar durante a partida altera apenas a aparência local.

## 7. Critérios de aceite

- [ ] **CA-01:** Preview usa assets otimizados.
- [ ] **CA-02:** Trocar durante a partida altera apenas a aparência local.
