# PRD — US 063 — Tela Mobile de configurações
...
Esta especificação detalha exclusivamente **US 063 — Tela Mobile de configurações**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Tela Mobile de configurações** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Não comprime as opções em modal de 54dvh.
- **RF-02:** Voltar preserva preferências e rota anterior.

## 7. Critérios de aceite

- [ ] **CA-01:** Não comprime as opções em modal de 54dvh.
- [ ] **CA-02:** Voltar preserva preferências e rota anterior.
