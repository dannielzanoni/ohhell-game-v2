...
Esta especificação detalha exclusivamente **US 061 — Verso da carta**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Verso da carta** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Valor inválido retorna ao padrão.
- **RF-02:** Preview e mesa usam a mesma preferência.

## 7. Critérios de aceite

- [ ] **CA-01:** Valor inválido retorna ao padrão.
- [ ] **CA-02:** Preview e mesa usam a mesma preferência.
