# PRD — US 070 — Navegação do guia Web
...
Esta especificação detalha exclusivamente **US 070 — Navegação do guia Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Navegação do guia Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
