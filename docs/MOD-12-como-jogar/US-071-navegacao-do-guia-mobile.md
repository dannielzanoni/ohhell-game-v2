# PRD — US 071 — Navegação do guia Mobile
...
Esta especificação detalha exclusivamente **US 071 — Navegação do guia Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Navegação do guia Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Não há scroll horizontal.
- **RF-02:** Estado de seção não interfere com browser back.

## 7. Critérios de aceite

- [ ] **CA-01:** Não há scroll horizontal.
- [ ] **CA-02:** Estado de seção não interfere com browser back.
