# PRD — US 054 — Carregamento do ranking
...
Esta especificação detalha exclusivamente **US 054 — Carregamento do ranking**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Carregamento do ranking** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Loading, dados, vazio e erro são modelados no controller.
- **RF-02:** Refresh preserva dados anteriores até a resposta.

## 7. Critérios de aceite

- [ ] **CA-01:** Loading, dados, vazio e erro são modelados no controller.
- [ ] **CA-02:** Refresh preserva dados anteriores até a resposta.
