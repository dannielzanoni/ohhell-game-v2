...
Esta especificação detalha exclusivamente **US 055 — Tabela Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Tabela Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Exibe posição, jogador, jogos, vitórias, win rate, rounds, bid, média, trunfos e favorita.
- **RF-02:** Cabe/rola de forma acessível em telas menores de Web.

## 7. Critérios de aceite

- [ ] **CA-01:** Exibe posição, jogador, jogos, vitórias, win rate, rounds, bid, média, trunfos e favorita.
- [ ] **CA-02:** Cabe/rola de forma acessível em telas menores de Web.
