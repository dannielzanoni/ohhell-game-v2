...
Esta especificação detalha exclusivamente **US 056 — Cards Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Cards Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Métricas secundárias podem expandir por jogador.
- **RF-02:** Não existe tabela horizontal obrigatória.

## 7. Critérios de aceite

- [ ] **CA-01:** Métricas secundárias podem expandir por jogador.
- [ ] **CA-02:** Não existe tabela horizontal obrigatória.
