# PRD — US 058 — Minhas estatísticas
...
Esta especificação detalha exclusivamente **US 058 — Minhas estatísticas**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Minhas estatísticas** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Caso de uso para `GET /stats/me` existe e trata `null`.
- **RF-02:** A ativação visual será feita sob feature flag sem duplicar o ranking global.

## 7. Critérios de aceite

- [ ] **CA-01:** Caso de uso para `GET /stats/me` existe e trata `null`.
- [ ] **CA-02:** A ativação visual será feita sob feature flag sem duplicar o ranking global.
