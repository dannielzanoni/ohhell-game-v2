# PRD — US 053 — Resultado sem vencedor
...
Esta especificação detalha exclusivamente **US 053 — Resultado sem vencedor**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Resultado sem vencedor** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Mensagem e visual são distintos do vencedor.
- **RF-02:** Reduced motion remove loops decorativos sem esconder o resultado.

## 7. Critérios de aceite

- [ ] **CA-01:** Mensagem e visual são distintos do vencedor.
- [ ] **CA-02:** Reduced motion remove loops decorativos sem esconder o resultado.
