# PRD — US 051 — Perda de vidas

**Módulo:** MOD 08 — Rodada, vidas e fim de jogo  
**Status:** Planejado  
...
Esta especificação detalha exclusivamente **US 051 — Perda de vidas**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Perda de vidas** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Cálculo vem do reducer compartilhado.
- **RF-02:** Web usa canto não intrusivo; Mobile usa banner/toast seguro.
- **RF-03:** Texto não contém nome hardcoded e é totalmente traduzível.

## 7. Critérios de aceite

- [ ] **CA-01:** Cálculo vem do reducer compartilhado.
- [ ] **CA-02:** Web usa canto não intrusivo; Mobile usa banner/toast seguro.
- [ ] **CA-03:** Texto não contém nome hardcoded e é totalmente traduzível.
