# PRD — US 052 — Resultado com vencedor
...
Esta especificação detalha exclusivamente **US 052 — Resultado com vencedor**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Resultado com vencedor** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Empates/vários vencedores são suportados.
- **RF-02:** Avatar possui fallback.
- **RF-03:** Voltar fecha recursos da partida e navega para criação/menu definido.

## 7. Critérios de aceite

- [ ] **CA-01:** Empates/vários vencedores são suportados.
- [ ] **CA-02:** Avatar possui fallback.
- [ ] **CA-03:** Voltar fecha recursos da partida e navega para criação/menu definido.
