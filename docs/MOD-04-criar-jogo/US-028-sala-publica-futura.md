# PRD — US 028 — Sala pública futura
...
Esta especificação detalha exclusivamente **US 028 — Sala pública futura**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Sala pública futura** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** O controle permanece oculto ou claramente marcado como indisponível.
- **RF-02:** Ativação futura exige contrato e história próprios; não enviar campo ignorado.

## 7. Critérios de aceite

- [ ] **CA-01:** O controle permanece oculto ou claramente marcado como indisponível.
- [ ] **CA-02:** Ativação futura exige contrato e história próprios; não enviar campo ignorado.
