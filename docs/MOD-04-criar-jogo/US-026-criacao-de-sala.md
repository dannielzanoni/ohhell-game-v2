...
Esta especificação detalha exclusivamente **US 026 — Criação de sala**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Criação de sala** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Executa uma única chamada `POST /lobby`.
- **RF-02:** Sucesso navega para `/game/:lobbyId`.
- **RF-03:** Loading bloqueia duplo submit; erro permite tentar novamente.

## 7. Critérios de aceite

- [ ] **CA-01:** Executa uma única chamada `POST /lobby`.
- [ ] **CA-02:** Sucesso navega para `/game/:lobbyId`.
- [ ] **CA-03:** Loading bloqueia duplo submit; erro permite tentar novamente.
