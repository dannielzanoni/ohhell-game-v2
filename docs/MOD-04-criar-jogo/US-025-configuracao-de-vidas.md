# PRD — US 025 — Configuração de vidas

**Módulo:** MOD 04 — Criar jogo  
**Status:** Planejado  
...
configurar e criar uma sala com experiência adequada a cada plataforma.

Esta especificação detalha exclusivamente **US 025 — Configuração de vidas**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Configuração de vidas** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Valor padrão é 5 e somente valores válidos são enviados.
- **RF-02:** O valor é preservado na navegação e recuperável por lobby.
- **RF-03:** Web pode usar combobox; Mobile usa stepper ou bottom sheet otimizado para toque.

## 7. Critérios de aceite

- [ ] **CA-01:** Valor padrão é 5 e somente valores válidos são enviados.
- [ ] **CA-02:** O valor é preservado na navegação e recuperável por lobby.
- [ ] **CA-03:** Web pode usar combobox; Mobile usa stepper ou bottom sheet otimizado para toque.

## 8. Diretriz técnica

Validar os dados antes da chamada, impedir submissão duplicada e manter a rota canônica após a criação.
