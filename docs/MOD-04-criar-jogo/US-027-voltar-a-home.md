...
Esta especificação detalha exclusivamente **US 027 — Voltar à Home**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Voltar à Home** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Voltar não cria lobby.
- **RF-02:** O comportamento de browser/back e botão da UI é consistente.

## 7. Critérios de aceite

- [ ] **CA-01:** Voltar não cria lobby.
- [ ] **CA-02:** O comportamento de browser/back e botão da UI é consistente.
