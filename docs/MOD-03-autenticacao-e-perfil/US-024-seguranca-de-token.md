...
Esta especificação detalha exclusivamente **US 024 — Segurança de token**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Segurança de token** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Tokens não são registrados em logs.
- **RF-02:** A URL do WebSocket com token não é exibida pela UI/telemetria.
- **RF-03:** A estratégia de armazenamento no navegador é documentada e não presume APIs nativas.

## 7. Critérios de aceite

- [ ] **CA-01:** Tokens não são registrados em logs.
- [ ] **CA-02:** A URL do WebSocket com token não é exibida pela UI/telemetria.
- [ ] **CA-03:** A estratégia de armazenamento no navegador é documentada e não presume APIs nativas.
