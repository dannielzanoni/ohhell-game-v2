# PRD — US 018 — Cadastro e atualização Guest
...
Esta especificação detalha exclusivamente **US 018 — Cadastro e atualização Guest**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Cadastro e atualização Guest** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Nick aceita até 24 caracteres em frontend e backend.
- **RF-02:** Salvar cria ou atualiza o guest conforme o token atual.
- **RF-03:** Feedback de sucesso/erro é equivalente em Web e Mobile.

## 7. Critérios de aceite

- [ ] **CA-01:** Nick aceita até 24 caracteres em frontend e backend.
- [ ] **CA-02:** Salvar cria ou atualiza o guest conforme o token atual.
- [ ] **CA-03:** Feedback de sucesso/erro é equivalente em Web e Mobile.
