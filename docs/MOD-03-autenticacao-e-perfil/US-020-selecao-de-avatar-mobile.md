# PRD — US 020 — Seleção de avatar Mobile
...
Esta especificação detalha exclusivamente **US 020 — Seleção de avatar Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Seleção de avatar Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Usa tela/bottom sheet com scroll e safe areas.
- **RF-02:** Selecionar não provoca scroll lock residual.
- **RF-03:** GIFs podem respeitar reduced motion/economia de dados.

## 7. Critérios de aceite

- [ ] **CA-01:** Usa tela/bottom sheet com scroll e safe areas.
- [ ] **CA-02:** Selecionar não provoca scroll lock residual.
- [ ] **CA-03:** GIFs podem respeitar reduced motion/economia de dados.
