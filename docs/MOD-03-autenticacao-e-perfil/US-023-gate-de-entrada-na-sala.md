# PRD — US 023 — Gate de entrada na sala
...
Esta especificação detalha exclusivamente **US 023 — Gate de entrada na sala**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Gate de entrada na sala** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Gate usa o mesmo controller nas views Web/Mobile.
- **RF-02:** Confirmar aguarda persistência antes de `PUT /lobby/:id`.
- **RF-03:** Repetir a ação não cria dois jogadores nem dois sockets.

## 7. Critérios de aceite

- [ ] **CA-01:** Gate usa o mesmo controller nas views Web/Mobile.
- [ ] **CA-02:** Confirmar aguarda persistência antes de `PUT /lobby/:id`.
- [ ] **CA-03:** Repetir a ação não cria dois jogadores nem dois sockets.
