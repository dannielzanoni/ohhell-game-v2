# PRD — US 019 — Seleção de avatar Web
...
Esta especificação detalha exclusivamente **US 019 — Seleção de avatar Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Seleção de avatar Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Escape fecha, foco fica preso e retorna ao gatilho.
- **RF-02:** PNG e GIF são agrupados e possuem seleção visível.
- **RF-03:** A lista não carrega mídia fora de viewport sem necessidade.

## 7. Critérios de aceite

- [ ] **CA-01:** Escape fecha, foco fica preso e retorna ao gatilho.
- [ ] **CA-02:** PNG e GIF são agrupados e possuem seleção visível.
- [ ] **CA-03:** A lista não carrega mídia fora de viewport sem necessidade.
