...
Esta especificação detalha exclusivamente **US 021 — Login Google**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Login Google** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Usa `POST /auth/google` do backend atualizado.
- **RF-02:** O guest atual é anexado quando aplicável.
- **RF-03:** Ausência de client ID oculta a opção sem quebrar a tela.
- **RF-04:** Erro do SDK/endpoint é recuperável.

## 7. Critérios de aceite

- [ ] **CA-01:** Usa `POST /auth/google` do backend atualizado.
- [ ] **CA-02:** O guest atual é anexado quando aplicável.
- [ ] **CA-03:** Ausência de client ID oculta a opção sem quebrar a tela.
- [ ] **CA-04:** Erro do SDK/endpoint é recuperável.
