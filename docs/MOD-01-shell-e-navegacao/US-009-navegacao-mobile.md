...
Esta especificação detalha exclusivamente **US 009 — Navegação Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Navegação Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Usa header compacto e bottom navigation para destinos primários.
- **RF-02:** Destinos secundários ficam em sheet/drawer.
- **RF-03:** Respeita `safe-area-inset-top` e `safe-area-inset-bottom`.
- **RF-04:** Alvos de toque têm ao menos 44×44 px.

## 7. Critérios de aceite

- [ ] **CA-01:** Usa header compacto e bottom navigation para destinos primários.
- [ ] **CA-02:** Destinos secundários ficam em sheet/drawer.
- [ ] **CA-03:** Respeita `safe-area-inset-top` e `safe-area-inset-bottom`.
- [ ] **CA-04:** Alvos de toque têm ao menos 44×44 px.
