...
Esta especificação detalha exclusivamente **US 012 — Tema no shell**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Tema no shell** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** A escolha é refletida imediatamente nas duas apresentações.
- **RF-02:** Não há flash de tema incorreto no carregamento.
- **RF-03:** Contraste atende WCAG AA.

## 7. Critérios de aceite

- [ ] **CA-01:** A escolha é refletida imediatamente nas duas apresentações.
- [ ] **CA-02:** Não há flash de tema incorreto no carregamento.
- [ ] **CA-03:** Contraste atende WCAG AA.
