# PRD — US 010 — Estado ativo e deep links
...
Esta especificação detalha exclusivamente **US 010 — Estado ativo e deep links**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Estado ativo e deep links** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** O destino ativo é equivalente em Web e Mobile.
- **RF-02:** Abrir `/game/:lobbyId` diretamente funciona nas duas views.
- **RF-03:** A rota desconhecida volta à Home sem loop.

## 7. Critérios de aceite

- [ ] **CA-01:** O destino ativo é equivalente em Web e Mobile.
- [ ] **CA-02:** Abrir `/game/:lobbyId` diretamente funciona nas duas views.
- [ ] **CA-03:** A rota desconhecida volta à Home sem loop.
