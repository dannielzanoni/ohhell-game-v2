# PRD — US 011 — Configurações a partir do shell
...
Esta especificação detalha exclusivamente **US 011 — Configurações a partir do shell**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Configurações a partir do shell** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Web abre modal/painel; Mobile abre tela ou bottom sheet própria.
- **RF-02:** Fechar retorna ao foco/origem anterior.
- **RF-03:** A mesa define um acesso que não bloqueia cartas ou controles.

## 7. Critérios de aceite

- [ ] **CA-01:** Web abre modal/painel; Mobile abre tela ou bottom sheet própria.
- [ ] **CA-02:** Fechar retorna ao foco/origem anterior.
- [ ] **CA-03:** A mesa define um acesso que não bloqueia cartas ou controles.
