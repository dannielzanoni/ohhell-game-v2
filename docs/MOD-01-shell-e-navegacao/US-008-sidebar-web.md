# PRD — US 008 — Sidebar Web

**Módulo:** MOD 01 — Shell e navegação  
**Status:** Planejado  
...
fornecer navegação própria por plataforma com as mesmas rotas e capacidades.

Esta especificação detalha exclusivamente **US 008 — Sidebar Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Sidebar Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Exibe Home, Criar jogo, Salas, Ranking, Como jogar, GitHub, Configurações e Idioma.
- **RF-02:** Mantém estado recolhido entre sessões.
- **RF-03:** Possui labels/tooltip no modo recolhido e navegação por teclado.
- **RF-04:** O conteúdo recebe offset correto sem salto de layout.

## 7. Critérios de aceite

- [ ] **CA-01:** Exibe Home, Criar jogo, Salas, Ranking, Como jogar, GitHub, Configurações e Idioma.
- [ ] **CA-02:** Mantém estado recolhido entre sessões.
- [ ] **CA-03:** Possui labels/tooltip no modo recolhido e navegação por teclado.
- [ ] **CA-04:** O conteúdo recebe offset correto sem salto de layout.

## 8. Diretriz técnica

Usar CSS mobile-first, breakpoint único em 768 px, navegação acessível e preservação de estado durante resize.
