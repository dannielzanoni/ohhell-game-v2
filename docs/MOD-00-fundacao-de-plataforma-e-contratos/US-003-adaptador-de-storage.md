# PRD — US 003 — Adaptador de storage
...
Esta especificação detalha exclusivamente **US 003 — Adaptador de storage**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Adaptador de storage** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Nenhum caso de uso acessa `localStorage` diretamente.
- **RF-02:** Chaves atuais são migradas sem perda de dados.
- **RF-03:** Falhas de storage não impedem uso da aplicação.
- **RF-04:** Tokens e preferências possuem testes de migração.

## 7. Critérios de aceite

- [ ] **CA-01:** Nenhum caso de uso acessa `localStorage` diretamente.
- [ ] **CA-02:** Chaves atuais são migradas sem perda de dados.
- [ ] **CA-03:** Falhas de storage não impedem uso da aplicação.
- [ ] **CA-04:** Tokens e preferências possuem testes de migração.
