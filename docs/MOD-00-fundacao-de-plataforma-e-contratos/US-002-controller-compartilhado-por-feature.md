# PRD — US 002 — Controller compartilhado por feature
...
Esta especificação detalha exclusivamente **US 002 — Controller compartilhado por feature**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Controller compartilhado por feature** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Cada route component monta um controller e uma view.
- **RF-02:** Views não importam services ou infrastructure.
- **RF-03:** Web e Mobile recebem o mesmo contrato de view model e ações.

## 7. Critérios de aceite

- [ ] **CA-01:** Cada route component monta um controller e uma view.
- [ ] **CA-02:** Views não importam services ou infrastructure.
- [ ] **CA-03:** Web e Mobile recebem o mesmo contrato de view model e ações.
