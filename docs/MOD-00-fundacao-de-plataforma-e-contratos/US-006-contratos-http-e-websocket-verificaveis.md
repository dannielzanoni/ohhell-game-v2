# PRD — US 006 — Contratos HTTP e WebSocket verificáveis
...
Esta especificação detalha exclusivamente **US 006 — Contratos HTTP e WebSocket verificáveis**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Contratos HTTP e WebSocket verificáveis** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Há fixtures para todos os endpoints e tipos de mensagem.
- **RF-02:** CI valida serialização de comandos e mensagens.
- **RF-03:** Diferenças entre checkout local e `origin/main` são resolvidas antes do desenvolvimento.

## 7. Critérios de aceite

- [ ] **CA-01:** Há fixtures para todos os endpoints e tipos de mensagem.
- [ ] **CA-02:** CI valida serialização de comandos e mensagens.
- [ ] **CA-03:** Diferenças entre checkout local e `origin/main` são resolvidas antes do desenvolvimento.
