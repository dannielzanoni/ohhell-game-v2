# PRD — US 004 — Cliente HTTP compartilhado
...
Esta especificação detalha exclusivamente **US 004 — Cliente HTTP compartilhado**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Cliente HTTP compartilhado** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Suporta base URL, query, JSON, cancelamento, autenticação e erro tipado.
- **RF-02:** Access token é anexado por interceptor/adaptador.
- **RF-03:** Respostas de erro preservam status e payload.

## 7. Critérios de aceite

- [ ] **CA-01:** Suporta base URL, query, JSON, cancelamento, autenticação e erro tipado.
- [ ] **CA-02:** Access token é anexado por interceptor/adaptador.
- [ ] **CA-03:** Respostas de erro preservam status e payload.
