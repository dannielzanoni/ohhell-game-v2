# PRD — US 005 — Cliente realtime compartilhado
...
Esta especificação detalha exclusivamente **US 005 — Cliente realtime compartilhado**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Cliente realtime compartilhado** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Há exatamente um socket por `GameRoute` montado.
- **RF-02:** Comandos durante `CONNECTING` são enfileirados.
- **RF-03:** Desmontagem fecha socket e timers.
- **RF-04:** Reconexão consome `Snapshot` e recompõe o estado.
- **RF-05:** Trocar Web/Mobile não reconecta.

## 7. Critérios de aceite

- [ ] **CA-01:** Há exatamente um socket por `GameRoute` montado.
- [ ] **CA-02:** Comandos durante `CONNECTING` são enfileirados.
- [ ] **CA-03:** Desmontagem fecha socket e timers.
- [ ] **CA-04:** Reconexão consome `Snapshot` e recompõe o estado.
- [ ] **CA-05:** Trocar Web/Mobile não reconecta.
