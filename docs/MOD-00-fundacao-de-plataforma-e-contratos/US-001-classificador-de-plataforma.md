# PRD — US 001 — Classificador de plataforma

**Módulo:** MOD 00 — Fundação de plataforma e contratos  
**Status:** Planejado  
...
Esta especificação detalha exclusivamente **US 001 — Classificador de plataforma**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Classificador de plataforma** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Mobile é o padrão abaixo de 768 px; Desktop é aplicado a partir de 768 px.
- **RF-02:** O CSS é escrito mobile-first: regras base para Mobile e media queries `min-width` para Desktop.
- **RF-03:** Existe override não persistente de QA (`?ui=mobile|web`).
- **RF-04:** A troca de largura preserva rota, dados carregados, formulário e sessão.
- **RF-05:** O classificador é testável sem `window` real.

## 7. Critérios de aceite

- [ ] **CA-01:** Mobile é o padrão abaixo de 768 px; Desktop é aplicado a partir de 768 px.
- [ ] **CA-02:** O CSS é escrito mobile-first: regras base para Mobile e media queries `min-width` para Desktop.
- [ ] **CA-03:** Existe override não persistente de QA (`?ui=mobile|web`).
- [ ] **CA-04:** A troca de largura preserva rota, dados carregados, formulário e sessão.
- [ ] **CA-05:** O classificador é testável sem `window` real.
...
- **CT-05:** comprovar CA-05 no(s) viewport(s) aplicável(is), incluindo o estado de falha quando pertinente.
