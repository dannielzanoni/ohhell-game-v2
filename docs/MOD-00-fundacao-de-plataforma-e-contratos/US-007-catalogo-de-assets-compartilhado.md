# PRD — US 007 — Catálogo de assets compartilhado
...
Esta especificação detalha exclusivamente **US 007 — Catálogo de assets compartilhado**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Catálogo de assets compartilhado** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** `authService` e domínio não importam `components`.
- **RF-02:** Rank/suit, labels e resolução de avatar têm uma única implementação.
- **RF-03:** Assets Mobile podem ser otimizados sem mudar os contratos de domínio.

## 7. Critérios de aceite

- [ ] **CA-01:** `authService` e domínio não importam `components`.
- [ ] **CA-02:** Rank/suit, labels e resolução de avatar têm uma única implementação.
- [ ] **CA-03:** Assets Mobile podem ser otimizados sem mudar os contratos de domínio.
