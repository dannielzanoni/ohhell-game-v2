# PRD — US 067 — Conteúdo responsivo sem chave visual

**Módulo:** MOD 11 — Idioma e conteúdo  
**Status:** Planejado  
...
manter PT/EN completos e independentes de layout.

Esta especificação detalha exclusivamente **US 067 — Conteúdo responsivo sem chave visual**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Conteúdo responsivo sem chave visual** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Remove a dependência de `appNameShort`/`appNameShort2` para montar layout.
- **RF-02:** Quebras de linha são responsabilidade da view/CSS.

## 7. Critérios de aceite

- [ ] **CA-01:** Remove a dependência de `appNameShort`/`appNameShort2` para montar layout.
- [ ] **CA-02:** Quebras de linha são responsabilidade da view/CSS.

## 8. Diretriz técnica

Traduções devem ter paridade PT/EN, sem strings de produto hardcoded ou chaves criadas apenas para controlar layout.
