# PRD — US 068 — Formatação localizada
...
Esta especificação detalha exclusivamente **US 068 — Formatação localizada**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Formatação localizada** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Usa `Intl.NumberFormat`/recursos equivalentes.
- **RF-02:** Naipes e ranks são traduzidos pelo catálogo.

## 7. Critérios de aceite

- [ ] **CA-01:** Usa `Intl.NumberFormat`/recursos equivalentes.
- [ ] **CA-02:** Naipes e ranks são traduzidos pelo catálogo.
