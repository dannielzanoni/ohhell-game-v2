# PRD — US 066 — Paridade de traduções
...
Esta especificação detalha exclusivamente **US 066 — Paridade de traduções**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Paridade de traduções** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** CI falha por chave ausente ou extra.
- **RF-02:** Não há strings de produto hardcoded em componentes, incluindo cartas, erros e “João plays”.

## 7. Critérios de aceite

- [ ] **CA-01:** CI falha por chave ausente ou extra.
- [ ] **CA-02:** Não há strings de produto hardcoded em componentes, incluindo cartas, erros e “João plays”.
