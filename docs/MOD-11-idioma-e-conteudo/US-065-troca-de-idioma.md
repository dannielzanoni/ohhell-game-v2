...
Esta especificação detalha exclusivamente **US 065 — Troca de idioma**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Troca de idioma** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Toda view reage sem reload.
- **RF-02:** Idioma inválido usa fallback definido.

## 7. Critérios de aceite

- [ ] **CA-01:** Toda view reage sem reload.
- [ ] **CA-02:** Idioma inválido usa fallback definido.
