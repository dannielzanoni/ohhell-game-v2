# PRD — US 016 — Resumo de perfil na Home
...
Esta especificação detalha exclusivamente **US 016 — Resumo de perfil na Home**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Resumo de perfil na Home** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Estado salvo é o mesmo em Web e Mobile.
- **RF-02:** A UI Mobile não exige modal maior que o viewport.
- **RF-03:** Erros de autenticação permanecem próximos da ação.

## 7. Critérios de aceite

- [ ] **CA-01:** Estado salvo é o mesmo em Web e Mobile.
- [ ] **CA-02:** A UI Mobile não exige modal maior que o viewport.
- [ ] **CA-03:** Erros de autenticação permanecem próximos da ação.
