# PRD — US 014 — Hero Mobile otimizado

**Módulo:** MOD 02 — Home Page  
**Status:** Planejado  
...
apresentar o produto, perfil e entradas principais com composições distintas.

Esta especificação detalha exclusivamente **US 014 — Hero Mobile otimizado**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Hero Mobile otimizado** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** O vídeo pesado não carrega automaticamente em conexão econômica ou reduced motion.
- **RF-02:** CTA de jogar/criar fica visível no primeiro viewport.
- **RF-03:** O título não depende de hacks de duas traduções separadas.

## 7. Critérios de aceite

- [ ] **CA-01:** O vídeo pesado não carrega automaticamente em conexão econômica ou reduced motion.
- [ ] **CA-02:** CTA de jogar/criar fica visível no primeiro viewport.
- [ ] **CA-03:** O título não depende de hacks de duas traduções separadas.

## 8. Diretriz técnica

Priorizar carregamento Mobile, mídia opcional, lazy loading e continuidade da navegação quando assets falharem.
