...
Esta especificação detalha exclusivamente **US 015 — Atalhos da Home**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Atalhos da Home** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Web usa grade; Mobile usa cards/lista de uma coluna.
- **RF-02:** Links internos usam router; externos indicam nova janela.
- **RF-03:** Todos têm nome acessível e feedback de interação.

## 7. Critérios de aceite

- [ ] **CA-01:** Web usa grade; Mobile usa cards/lista de uma coluna.
- [ ] **CA-02:** Links internos usam router; externos indicam nova janela.
- [ ] **CA-03:** Todos têm nome acessível e feedback de interação.
