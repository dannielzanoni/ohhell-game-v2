# PRD — US 017 — Estados de carregamento e indisponibilidade
...
Esta especificação detalha exclusivamente **US 017 — Estados de carregamento e indisponibilidade**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Estados de carregamento e indisponibilidade** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Assets possuem fallback visual.
- **RF-02:** Google indisponível não bloqueia guest.
- **RF-03:** A Home continua navegável sem backend.

## 7. Critérios de aceite

- [ ] **CA-01:** Assets possuem fallback visual.
- [ ] **CA-02:** Google indisponível não bloqueia guest.
- [ ] **CA-03:** A Home continua navegável sem backend.
