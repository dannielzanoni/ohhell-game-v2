...
Esta especificação detalha exclusivamente **US 013 — Hero Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Hero Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Hero, perfil e atalhos cabem no viewport comum de desktop sem ocultar ações.
- **RF-02:** Vídeo possui poster e respeita `prefers-reduced-motion`.
- **RF-03:** Ausência/falha do vídeo não impede a Home.

## 7. Critérios de aceite

- [ ] **CA-01:** Hero, perfil e atalhos cabem no viewport comum de desktop sem ocultar ações.
- [ ] **CA-02:** Vídeo possui poster e respeita `prefers-reduced-motion`.
- [ ] **CA-03:** Ausência/falha do vídeo não impede a Home.
