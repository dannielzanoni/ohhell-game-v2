...
Esta especificação detalha exclusivamente **US 032 — Entrar em uma sala**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Entrar em uma sala** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Navega para a rota canônica.
- **RF-02:** Erros 404, 409 e 403 recebem mensagens acionáveis.

## 7. Critérios de aceite

- [ ] **CA-01:** Navega para a rota canônica.
- [ ] **CA-02:** Erros 404, 409 e 403 recebem mensagens acionáveis.
