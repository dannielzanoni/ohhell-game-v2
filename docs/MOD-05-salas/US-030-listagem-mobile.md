...
Esta especificação detalha exclusivamente **US 030 — Listagem Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Listagem Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Cada card expõe identificação, contagem e CTA.
- **RF-02:** Identificadores longos truncam visualmente, mas podem ser copiados/lidos.

## 7. Critérios de aceite

- [ ] **CA-01:** Cada card expõe identificação, contagem e CTA.
- [ ] **CA-02:** Identificadores longos truncam visualmente, mas podem ser copiados/lidos.
