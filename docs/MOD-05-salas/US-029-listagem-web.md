...
Esta especificação detalha exclusivamente **US 029 — Listagem Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Listagem Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Exibe id, jogadores/capacidade, estado e ação Entrar.
- **RF-02:** Cabe em 768 px sem scroll horizontal desnecessário.

## 7. Critérios de aceite

- [ ] **CA-01:** Exibe id, jogadores/capacidade, estado e ação Entrar.
- [ ] **CA-02:** Cabe em 768 px sem scroll horizontal desnecessário.
