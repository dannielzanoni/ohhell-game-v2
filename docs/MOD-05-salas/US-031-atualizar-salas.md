...
listar e ingressar em lobbies públicos/abertos com views diferentes.

Esta especificação detalha exclusivamente **US 031 — Atualizar salas**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Atualizar salas** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Loading inicial, refresh, vazio e erro são distintos.
- **RF-02:** Refresh não apaga a lista válida antes da resposta.
- **RF-03:** Requisição anterior pode ser cancelada ao sair.

## 7. Critérios de aceite

- [ ] **CA-01:** Loading inicial, refresh, vazio e erro são distintos.
- [ ] **CA-02:** Refresh não apaga a lista válida antes da resposta.
- [ ] **CA-03:** Requisição anterior pode ser cancelada ao sair.

## 8. Diretriz técnica

Modelar loading, refresh, dados anteriores, vazio e erro como estados explícitos do controller.
