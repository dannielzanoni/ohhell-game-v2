# PRD — US 033 — Criar a partir de Salas
...
Esta especificação detalha exclusivamente **US 033 — Criar a partir de Salas**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Criar a partir de Salas** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** CTA está presente no header e estado vazio.
- **RF-02:** Usa a mesma rota `/create-game`.

## 7. Critérios de aceite

- [ ] **CA-01:** CTA está presente no header e estado vazio.
- [ ] **CA-02:** Usa a mesma rota `/create-game`.
