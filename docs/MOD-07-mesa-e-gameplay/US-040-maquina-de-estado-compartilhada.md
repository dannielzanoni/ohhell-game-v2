# PRD — US 040 — Máquina de estado compartilhada
...
Esta especificação detalha exclusivamente **US 040 — Máquina de estado compartilhada**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Máquina de estado compartilhada** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Estados contemplam `waiting`, `bidding`, `dealing` e `ended`.
- **RF-02:** Todos os 14 tipos de mensagem do servidor têm fixture e teste.
- **RF-03:** Mensagem desconhecida é ignorada/telemetrizada sem quebrar a sessão.

## 7. Critérios de aceite

- [ ] **CA-01:** Estados contemplam `waiting`, `bidding`, `dealing` e `ended`.
- [ ] **CA-02:** Todos os 14 tipos de mensagem do servidor têm fixture e teste.
- [ ] **CA-03:** Mensagem desconhecida é ignorada/telemetrizada sem quebrar a sessão.
