...
Esta especificação detalha exclusivamente **US 047 — Timer de ação**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Timer de ação** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Timer deriva do estado compartilhado.
- **RF-02:** Expiração automática segue a regra atual e é testada com clock falso.
- **RF-03:** Background/foreground não causa múltiplas expirações.

## 7. Critérios de aceite

- [ ] **CA-01:** Timer deriva do estado compartilhado.
- [ ] **CA-02:** Expiração automática segue a regra atual e é testada com clock falso.
- [ ] **CA-03:** Background/foreground não causa múltiplas expirações.
