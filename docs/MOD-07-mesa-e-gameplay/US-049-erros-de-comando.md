...
Esta especificação detalha exclusivamente **US 049 — Erros de comando**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Erros de comando** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Diferencia conexão indisponível, fase incorreta, fora de turno e erro do servidor.
- **RF-02:** Erro não remove carta definitivamente sem confirmação/snapshot.
- **RF-03:** Toast/banner não cobre controles essenciais no Mobile.

## 7. Critérios de aceite

- [ ] **CA-01:** Diferencia conexão indisponível, fase incorreta, fora de turno e erro do servidor.
- [ ] **CA-02:** Erro não remove carta definitivamente sem confirmação/snapshot.
- [ ] **CA-03:** Toast/banner não cobre controles essenciais no Mobile.
