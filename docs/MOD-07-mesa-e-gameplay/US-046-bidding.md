...
Esta especificação detalha exclusivamente **US 046 — Bidding**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Bidding** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Somente valores recebidos em `possible_bids` são habilitados.
- **RF-02:** Envio limpa os controles e aguarda evento do servidor.
- **RF-03:** Web e Mobile podem ter controles distintos, mas mesma ação.

## 7. Critérios de aceite

- [ ] **CA-01:** Somente valores recebidos em `possible_bids` são habilitados.
- [ ] **CA-02:** Envio limpa os controles e aguarda evento do servidor.
- [ ] **CA-03:** Web e Mobile podem ter controles distintos, mas mesma ação.
