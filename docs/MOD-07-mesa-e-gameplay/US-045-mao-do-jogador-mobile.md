# PRD — US 045 — Mão do jogador Mobile
...
Esta especificação detalha exclusivamente **US 045 — Mão do jogador Mobile**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Mão do jogador Mobile** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Cartas são roláveis/selecionáveis sem conflito com scroll da página.
- **RF-02:** A ação de jogar exige um gesto inequívoco; não dispara ao rolar.
- **RF-03:** Área de toque e carta selecionada são visíveis.

## 7. Critérios de aceite

- [ ] **CA-01:** Cartas são roláveis/selecionáveis sem conflito com scroll da página.
- [ ] **CA-02:** A ação de jogar exige um gesto inequívoco; não dispara ao rolar.
- [ ] **CA-03:** Área de toque e carta selecionada são visíveis.
