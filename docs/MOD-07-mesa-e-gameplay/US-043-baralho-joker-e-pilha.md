# PRD — US 043 — Baralho, joker e pilha
...
Esta especificação detalha exclusivamente **US 043 — Baralho, joker e pilha**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Baralho, joker e pilha** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Usa o deck selecionado e labels acessíveis.
- **RF-02:** A pilha mantém ordem e jogador de origem.
- **RF-03:** Destaque de carta fraca não altera regra nem bloqueia interação.

## 7. Critérios de aceite

- [ ] **CA-01:** Usa o deck selecionado e labels acessíveis.
- [ ] **CA-02:** A pilha mantém ordem e jogador de origem.
- [ ] **CA-03:** Destaque de carta fraca não altera regra nem bloqueia interação.
