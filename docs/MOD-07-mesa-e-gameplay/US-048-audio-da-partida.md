...
Esta especificação detalha exclusivamente **US 048 — Áudio da partida**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Áudio da partida** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Sons passam por adaptador único.
- **RF-02:** Volume 0 desativa reprodução.
- **RF-03:** Um evento não toca duas vezes ao trocar de view/reconectar.

## 7. Critérios de aceite

- [ ] **CA-01:** Sons passam por adaptador único.
- [ ] **CA-02:** Volume 0 desativa reprodução.
- [ ] **CA-03:** Um evento não toca duas vezes ao trocar de view/reconectar.
