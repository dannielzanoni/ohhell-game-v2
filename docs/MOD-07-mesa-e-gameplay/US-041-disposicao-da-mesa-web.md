# PRD — US 041 — Disposição da mesa Web
...
Esta especificação detalha exclusivamente **US 041 — Disposição da mesa Web**. Ela deve ser implementada no mesmo aplicativo React/Vite, usando a experiência Mobile abaixo de 768 px e a experiência Desktop a partir de 768 px.
...
Entregar **Disposição da mesa Web** de forma verificável, sem duplicar regras, estado, chamadas HTTP, sessão WebSocket ou persistência entre os layouts Mobile e Desktop.
...
- **RF-01:** Suporta o limite de jogadores aprovado sem sobreposição ilegível.
- **RF-02:** Jogador local, turno, bid, pontos, vidas e ready são distinguíveis.
- **RF-03:** Redimensionamento não perde o estado da partida.

## 7. Critérios de aceite

- [ ] **CA-01:** Suporta o limite de jogadores aprovado sem sobreposição ilegível.
- [ ] **CA-02:** Jogador local, turno, bid, pontos, vidas e ready são distinguíveis.
- [ ] **CA-03:** Redimensionamento não perde o estado da partida.
