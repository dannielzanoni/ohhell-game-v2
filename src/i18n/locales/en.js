export const en = {
  ...
  leaderboard: {
    ...
    rounds: 'Rounds',
    tableCaption: 'Leaderboard with position, player, games, wins, win rate, rounds, bid, average, trumps and favorite card.',
    tableScroll: 'Leaderboard table with horizontal scrolling',
    title: 'Leaderboard',
    trumps: 'Trumps',
    winRate: 'Win rate',
    wins: 'Wins',
