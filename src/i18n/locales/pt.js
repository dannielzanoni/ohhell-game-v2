export const pt = {
  ...
  leaderboard: {
    ...
    rounds: 'Rounds',
    tableCaption: 'Ranking com posição, jogador, jogos, vitórias, win rate, rounds, bid, média, trunfos e carta favorita.',
    tableScroll: 'Tabela do ranking com rolagem horizontal',
    title: 'Ranking',
    trumps: 'Trunfos',
