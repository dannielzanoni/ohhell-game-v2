export const pt = {
  ...
  leaderboard: {
    ...
    myStatsEmpty: 'Suas estatísticas ainda não estão disponíveis.',
    myStatsError: 'Não foi possível carregar suas estatísticas.',
    myStatsEyebrow: 'Área autenticada',
    myStatsTitle: 'Minhas estatísticas',
    noRounds: 'Sem rounds',
    player: 'Player',
    rounds: 'Rounds',
    title: 'Ranking',
