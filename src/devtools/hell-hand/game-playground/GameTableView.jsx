...
import magicCardBack from '@/games/hell-hand/assets/cards/back_card_magic.jpg';
    ...
    >
      <div className="relative h-32 w-[4.65rem]">
        <img
          src={magicCardBack}
          alt=""
          className="absolute -left-2 -top-2 size-full rounded-lg border-2 border-violet-200/20 object-cover opacity-45"
          draggable="false"
        />
        <img
          src={magicCardBack}
          alt="Deck mágico"
          className="relative size-full rounded-lg border-2 border-violet-200/50 object-cover shadow-2xl shadow-black/70"
          draggable="false"
        />
        <span className="absolute -right-2 -top-2 grid size-7 place-items-center rounded-full bg-violet-200 text-xs font-black text-zinc-950 shadow-lg">
          {count}
        </span>
      </div>
  ...
  return (
    ...
    >
      {topCard?.image || topCard?.image_url ? (
        <img
          src={topCard.image || topCard.image_url}
          alt=""
          className="absolute inset-2 size-[calc(100%-1rem)] rounded object-cover opacity-55"
          draggable="false"
        />
      ) : null}
