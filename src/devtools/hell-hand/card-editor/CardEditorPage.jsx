...
import { getAuthPlayer, isCurrentUserAdmin } from '@/features/auth/api/authService.js';
import {
  createCardDefinition,
  getCardDefinitions,
  updateCardDefinition,
  uploadCardDefinitionAsset,
} from '@/games/hell-hand/api/powerDecks.js';
                ...
                >
                  ...
                  {publishSuccess ? (
                    <Button asChild variant="link" className="ml-2 h-auto p-0">
                      <Link to="/dev/hell-hand/power-decks">
