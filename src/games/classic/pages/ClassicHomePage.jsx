...
import card1Espada8Bit from '@/games/classic/assets/cards/spanish-8bit/1espada.png';
import card3Paus8Bit from '@/games/classic/assets/cards/spanish-8bit/3paus.png';
import card12Copas8Bit from '@/games/classic/assets/cards/spanish-8bit/12copas.png';
import gameBg from '@/games/classic/assets/videos/game-bg.mp4';
import { LoginCard } from '@/features/auth/components/LoginCard.jsx';
import { GameSettingsModal } from '@/features/settings/components/GameSettingsModal.jsx';
import { VideoText } from '@/shared/ui/video-text.jsx';
import { LANGUAGE_STORAGE_KEY } from '@/shared/i18n/index.js';
import { authService } from '@/features/auth/api/authService.js';
import { getMyStats } from '@/games/classic/api/stats.js';

const homeActions = [
  { icon: Play, labelKey: 'common.play', path: '/classic/create-game' },
  { icon: Users, labelKey: 'pages.links.rooms.label', path: '/classic/rooms' },
  { icon: Crown, labelKey: 'pages.links.leaderboard.label', path: '/classic/leaderboard' },
  { icon: BookOpen, labelKey: 'pages.links.howToPlay.label', path: '/classic/how-to-play' },
];
