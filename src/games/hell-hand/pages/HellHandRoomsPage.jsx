...
import { getLobbies } from '@/games/core/api/lobby.js';
...
function isHellHandLobby(lobby) {
  return lobby?.game_type === GAME_TYPES.HELL_HAND;
}
                ...
                return (
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate(`/hell-hand/game/${lobbyId}`, {
                          state: {
                            gameType: lobby.game_type || GAME_TYPES.HELL_HAND,
